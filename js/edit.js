...
window.onload = () => {
    ...
    axios.post("http://localhost//ecommerce-backend/get_profile_api.php",data).then(result => {
...
data.append("user_id",1);
axios.post("http://localhost//ecommerce-backend/edit_profile_api.php",data).then(data =>console.log(data.result) ).catch(error => console.log(error))
})
